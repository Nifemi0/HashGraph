...
import { HashGraphCache, CURRENT_SCHEMA_VERSION, CURRENT_ENRICHMENT_VERSION } from '../src/engine/cache';
import { HashGraphSchema } from '../src/types/schema';
import fs from 'fs';
import path from 'path';

const TEST_DB_DIR = 'data_test';
const TEST_DB_NAME = 'test_hashgraph.db';

const getMockGraph = (evidence_score = 0.9): HashGraphSchema => ({
  metadata: {
    protocol_name: "Test",
