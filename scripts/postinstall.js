...
function banner() {
  ...
  console.log("");
  console.log(`${GREEN}${BOLD}  ⬡ HashGraph MCP ready${RESET}`);
  console.log(`  ${CYAN}npx -y hashgraph-mcp${RESET}   ${DIM}stdio MCP server${RESET}`);
  console.log(
    `  ${DIM}Claude/Cursor:${RESET} command=npx  args=["-y","hashgraph-mcp"]`
  );
  console.log(
    `  ${DIM}Docs:${RESET} https://hashgraph-eight.vercel.app/docs.html`
  );
  console.log("");
}
